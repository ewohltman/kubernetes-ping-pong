...
# Undeploy ping
kubectl delete -f ${SCRIPT_DIR}/../deployments/ping/virtualservice.yml --ignore-not-found
kubectl delete -f ${SCRIPT_DIR}/../deployments/ping/gateway.yml --ignore-not-found
...
# Undeploy allow-all network policy
kubectl delete -f ${SCRIPT_DIR}/../deployments/ping/networkpolicy.yml --ignore-not-found
